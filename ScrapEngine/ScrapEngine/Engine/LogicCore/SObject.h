...
namespace ScrapEngine
{
	namespace Core
	{
		...
		protected:
			...
			glm::mat4 generate_transform_matrix(const ScrapEngine::Core::STransform& transform) const;
			...
			glm::mat4 generate_unscaled_transform_matrix(const ScrapEngine::Core::STransform& transform) const;
		public:
