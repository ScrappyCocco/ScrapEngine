...
namespace ScrapEngine {
	struct game_base_info {
		...
		game_base_info(const std::string& input_app_name, int input_app_version, uint32_t input_window_WIDTH, uint32_t input_window_HEIGHT, bool input_window_fullscreen, bool input_vsync)
