...
ScrapEngine::Render::SkyboxUniformBuffer::SkyboxUniformBuffer(const size_t swap_chain_images_size)
{
	const vk::DeviceSize buffer_size(sizeof(SkyboxUniformBufferObject));
...
void ScrapEngine::Render::SkyboxUniformBuffer::update_uniform_buffer_transform(const Core::STransform& object_transform)
{
	//Traslate
...
void ScrapEngine::Render::SkyboxUniformBuffer::update_uniform_buffer_camera_data(Camera* render_camera)
{
...
void ScrapEngine::Render::SkyboxUniformBuffer::finish_update_uniform_buffer(const uint32_t current_image)
{
